...
writeFileSync(file, `INSERT INTO users(id,username,password_hash,role,created_at) VALUES('${randomUUID()}','${escape(username)}','${encoded}','admin',${Math.floor(Date.now()/1000)});\n`, { mode: 0o600 })
